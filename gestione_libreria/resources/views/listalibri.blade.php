            ...
            @foreach($books as $book)
                <div class="cardBook bg-white overflow-hidden shadow-sm sm:rounded-lg flex my-2 mx-4">
                    ...
                    <div class="p-6 col-md-7 col-sm-7">
                        ...
                        <p class="card-text text-secondary mb-2 fs-6"></p>
                        <div class="pt-2" style="border-top: 1px solid #F87060;">
                        ...
                        <div>
                            <a href="{{ route('books.show', $book->id) }}" class="detailButton mt-4 btn btn-warning">View Details</a>
                        </div>
                    </div>
                    <div class="flex-column justify-between pt-4 col-md-3 col-sm-2">
                        ...
                        @if ($book->AvailableAmount > 0 && !in_array($book->id, $userPendingReservations))
                            <form action="{{ route('reservation.store') }}" method="POST">
                                ...
                                <button type="submit" class="reserveButton btn btn-outline-success" style="text-decoration: none;">Reserve</button>
                            </form>
                        @endif
                    </div>
                </div>
